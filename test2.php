...
<body class="page--sorting">
  <div id="content" class="main">
    <div class="container">
  <h1 style="color: black;">Player Grid</h1>




    <div style="font-size: 24px; margin-left: 15px;"><?php
      ...
      ?>,</div>
      <p></p>
      <div style="font-size: 16px; margin-left: 15px;">please select a client</div>
      <p></p>

      <div class="big-demo go-wide" data-js="sorting-demo">
          <div  class="button-group sort-by-button-group js-radio-button-group" style="position: center; margin-left: -40px; text-align: center;">
              ...
              <button class="button_slide slide_down" style="background-color: white;"data-sort-value="symbol">last name</button>
                <div class="dropdown">
                  ...
                  <div id="myDropdown" class="dropdown-content" style="width: 50px;">
                    ...
                    <div style="margin: 5px; ">AGENT ID: <?php echo $_COOKIE['name'];?></div>
                    <a href="login.php" style="border-radius: 5px;" class="button_slide slide_left">Logout</a>
                  </div>
                </div>
      ...
      <div class="button-group filter-button-group">
        <input type="text" class="quicksearch" placeholder="Search" style="color: white; border: none; width: 100px; border-bottom: 3px solid black; "id="myInput" />
